...
plt.plot(terms, bear_steepener, label='after steepener')
plt.plot(terms, sofr_swaps, label='before steepener')
plt.xlabel('time (years)')
...
# Plot of difference between new weights and initial weights. Increase in low maturity weights
plt.bar(terms, (new_weights - init_weights) * 15, label='before steepener')
